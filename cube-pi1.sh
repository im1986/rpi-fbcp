...
#sudo sed -i '/^exit\ 0/i\sudo\ modprobe\ fbtft_device\ debug=3\ rotate=0\ name=flexfb\ speed=64000000\ gpios=reset:27,dc:25,led:24' rc.local
...
cd /etc/modprobe.d/
sudo sed -i '$a options fbtft_device name=flexfb debug=3 rotate=0 bgr=1 fps=60 custom=1 height=240 width=240 speed=64000000 gpios=reset:27,dc:25,led:24' fbtft.cong
